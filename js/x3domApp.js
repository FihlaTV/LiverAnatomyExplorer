 ...
 * Datei: x3domApp.js
 * Version: 2.0.11
 * Letztes Update: 23.02.15
 * 
 * Changelog:
 * -----------------------------------
 * 2.0.11
 *  - Bugfix: Drücken der mittleren und rechten Maustaste führten zur Verschiebung der gesamten Scene
 * 2.0.10
       ...
       va.onDrag = function (x, y, buttonState)
       {
        ...
        if (navi._vf.type[0].toLowerCase() === "examine")
        {
            ...
            if (buttonState & 4) //middle mouse button ==> translate scene
            {
                ...
                */
                d = 450; // TODO: Mouse events only work correctly with this manually set value 
